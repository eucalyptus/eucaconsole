...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      this.create_with_enter = this.options.create_with_enter || false;
    ...
    AbstractChosen.prototype.keyup_checker = function(evt) {
      ...
      switch (stroke) {
        ...
        case 13:
          evt.preventDefault();
          searchText = this.get_search_text();
          if (this.create_option && this.create_with_enter && this.results_showing && searchText.length) {
            this.select_create_option(searchText);
            return this.results_hide();
          }
          if (this.results_showing) {
