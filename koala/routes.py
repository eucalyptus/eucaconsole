...
urls = [
    ...
    Route(name='scalinggroup_policy_create', pattern='/scalinggroups/{id}/policy/create'),
    Route(name='scalinggroup_policy_delete', pattern='/scalinggroups/{id}/policy/delete'),
