...
class Volume_operations_sequence(GuiEC2):
    ...
    def volume_ops_test(self):
        ...
        self.tester.attach_volume_from_instance_detail_page(volume1_id, instance1_id)
        self.tester.detach_volume_from_volumes_lp(volume1_id)
        self.tester.attach_volume_from_instance_lp(volume1_id, instance1_id)
        self.tester.detach_volume_from_volumes_lp(volume1_id)
        self.tester.attach_volume_from_volume_detail_page(instance1_id, volume1_id)
        self.tester.detach_volume_from_volumes_lp(volume1_id)
        self.tester.attach_volume_from_volume_lp(instance1_id, volume1_id)
