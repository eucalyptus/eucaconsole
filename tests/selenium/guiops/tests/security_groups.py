...
class SecurityGroupOperationsSequence(GuiOps):
    ...
    def security_group_ops_test(self):
        ...
        group3 = self.tester.create_sesecurity_group_with_rules(
            s_group_name_3, self.s_group_description, "RDP", "Custom TCP", "22", "1024")
...
if __name__ == '__main__':
        tester = SecurityGroupOperationsSequence()
        SecurityGroupOperationsSequence.security_group_ops_test(tester)
