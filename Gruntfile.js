    ...
    grunt.initConfig({
        ...
        concat: {
            options: {
                sourceMap: true,
                stripBanners: true,
                banner: grunt.file.read('eucaconsole/static/banners/js.banner.txt')
            },
            elbWizard: {
                src: [
                   ...
                   'eucaconsole/static/js/pages/elb-wizard/general.js',
                   'eucaconsole/static/js/pages/elb-wizard/instances.js',
                   'eucaconsole/static/js/pages/elb-wizard/network.js',
                   'eucaconsole/static/js/pages/elb-wizard/advanced.js',
                   'eucaconsole/static/js/widgets/listener-editor/listener-editor.js',
                   ...
                   'eucaconsole/static/js/widgets/tag-editor/tag-editor.js'
                ],
                dest: 'eucaconsole/static/js/dist/elb-wizard.js'
            }
        },
        htmlmin: { 
            production: {
        ...
        htmllint: {
            ...
            elb: [
                'eucaconsole/templates/dialogs/select_certificate_dialog.pt',
